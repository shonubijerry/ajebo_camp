...
INSERT INTO "new_Camp" ("banner", "created_at", "deleted_at", "end_date", "entity_id", "fee", "id", "start_date", "theme", "title", "updated_at", "verse", "year") SELECT "banner", "created_at", "deleted_at", "end_date", "entity_id", "fee", "id", "start_date", "theme", "title", "updated_at", "verse", "year" FROM "Camp";
DROP TABLE "Camp";
