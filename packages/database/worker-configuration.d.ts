/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d0933bfb3e258635a5ef1d4123ccc478)
// Runtime types generated with workerd@1.20251202.0 2025-04-16 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		WRANGLER_ENVIRONMENT: "development" | "staging";
		DATABASE_URL: string;
		DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WRANGLER_ENVIRONMENT" | "DATABASE_URL">> {}
}
