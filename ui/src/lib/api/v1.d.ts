...
export interface paths {
    ...
    "/api/v1/media/{key}": {
         ...
         */
        get: operations["get_GetMediaEndpoint"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface operations {
                ...
                content: {
                    "application/json": {
                        ...
                        data: {
                            ...
                            permissions: ("dashboard:view" | "camp:view" | "camp:create" | "camp:update" | "camp:delete" | "campite:view" | "campite:create" | "campite:update" | "campite:delete" | "campite:export" | "camp-allocation:view" | "camp-allocation:create" | "camp-allocation:update" | "camp-allocation:delete" | "district:view" | "district:create" | "district:update" | "district:delete" | "entity:view" | "entity:create" | "entity:update" | "entity:delete" | "payment:view" | "analytics:view" | "user:manage" | "settings:manage")[];
                        };
                    };
                };
            };
    ...
    patch_BulkUpdateCampitesEndpoint: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody?: {
            content: {
                "application/json": {
                    /** @description Array of campite IDs to update */
                    ids: string[];
